...
public class FrozenPlayerManager {
	...
	private final List<UUID> pausedPlayers = new ArrayList<>();
	...
	private void addPlayer(Player player) {
		frozenPlayers.put(player.getUniqueId(), plugin.getConfig().getInt("time-limit"));
	}
	...
	public boolean isPaused(Player player) {
		return pausedPlayers.contains(player.getUniqueId());
	}
